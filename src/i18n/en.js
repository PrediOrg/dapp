export default {
    ...
    deposit: "Add",
    verifiedNFT: "Check Verified NFT",
    select: "Select",
    selected: "Selected",
    moreNFT: "Get more NFT License",
    forecastEvent: "Event",
    ...
    cdsInfoOne: "When issue a betting product, you have to stake the margin, set the default odds and the minimum investment amount.",
    cdsInfoTwo: "Unparticipating margin can be withdrawn at any time.",
    cdsInfoThree: "If more than 1 of the users choose to appeal the judgment result, the community governance mechanism will be initiated to determine whether the betting event has occurred.",
    deposited: "Invested",
    issued: "Issued",
    ...
    appealInfoOne: 'If you think that the judgment of the current betting event deviates from the facts, you can "Challenge" and start the governance mechanism to finally determine the current betting result.',
    check: "Check",
    ...
    NFT: {
        ...
        issueTip:"Issue 10 Betting Products/NFT",
        price: "Price",
        success: "Success",
        getNFT: "Get NFT successfully",
